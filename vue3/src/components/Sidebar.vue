  ...
  <div class="flex">
    ...
    >
      ...
      <nav class="mt-10">
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Speech Data' ? activeClass : inactiveClass]"
          to="/speech_data"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class="mx-4">Speech Data</span>
        </router-link>
<!--
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'MLModel' ? activeClass : inactiveClass]"
          to="/model"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class="mx-4">Model</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Documents' ? activeClass : inactiveClass]"
          to="/Documents"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class="mx-4">Documents</span>
        </router-link>
