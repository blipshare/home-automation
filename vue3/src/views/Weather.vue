  ...
  <div class="flex w-full justify-center mt-2 mb-2">
    <div id="item1" class="carousel-item w-full">
      ...
      >
        <!-- Component Start -->
        <div
          class="mt-10 max-w-full max-h-full rounded-xl bg-white p-10 py-10 ring-8 ring-white ring-opacity-40"
        >
        ...
        >
          ...
          <div class="flex items-center justify-between">
            <span class="w-1/4 text-lg font-semibold">Sun, 24 Jan</span>
            <div class="flex w-1/4 items-center justify-end pr-10">
          ...
          <div class="flex items-center justify-between">
            <span class="w-1/4 text-lg font-semibold">Mon, 25 Jan</span>
            <div class="flex w-1/4 items-center justify-end pr-10">
          ...
          <div class="flex items-center justify-between">
            <span class="w-1/4 text-lg font-semibold">Tue, 26 Jan</span>
